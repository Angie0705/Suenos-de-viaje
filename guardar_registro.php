...
$sql_insert = "
    INSERT INTO REGISTRO (nombre, apellido, tipo_documento, numero_documento, edad, email, dudas)
...
if ($result) {
    echo json_encode(["success" => true, "message" => "Registro guardado correctamente en Oracle."]);
} else {
    $e = oci_error($stmt);
